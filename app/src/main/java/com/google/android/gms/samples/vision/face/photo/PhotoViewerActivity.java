...
//       Bitmap bitmap = BitmapFactory.decodeFile("/storage/emulated/legacy/Pictures/mona_lisa.jpg");
       ...
       ByteBuffer imageBuffer = ByteBuffer.wrap(buffer.array());
       Bitmap bitmapuse = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.ARGB_8888);
        bitmapuse.copyPixelsFromBuffer(imageBuffer);
...
//                .setTrackingEnabled(false)
        ...
        Frame frame = new Frame.Builder().setBitmap(bitmapuse).build();
...
//                Log.w(TAG, getString(R.string.low_storage_error));
        ...
        overlay.setContent(bitmapuse, faces);
